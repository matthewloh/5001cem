...
class PatientRegistrationForm(Frame):
    ...
    def createButtons(self):
        OPT1STR = "Existing Health Records"
        OPT2STR = "Current Medications"
        OPT3STR = "Allergies"
        OPT4STR = "Family History"
        OPT5STR = "Additional Biodata"
        OPT6STR = "Other Information"
        optList = [OPT1STR, OPT2STR, OPT3STR, OPT4STR, OPT5STR, OPT6STR]
